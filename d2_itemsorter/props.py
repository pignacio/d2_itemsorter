...
_PROPERTIES = {p.id: p for p in [
    ...
    PropertyDef(83, [8], '{:+d} to Sorceress Skill Levels', offsets=[8]),
    ...
    PropertyDef(112, [7], 'Hit Causes Monster to Flee {:d}%'),
    ...
    PropertyDef(339, [7], 'Chance to dodge missile attach when still +{:d}%'),
